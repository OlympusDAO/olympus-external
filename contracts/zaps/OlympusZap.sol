...
contract OlympusZap is ZapBaseV2_2 {
    ...
    function ZapIn(
        ...
        if (bond) {
            ...
            require(
                toToken == olympusZapManager.sOHM() || toToken == olympusZapManager.wsOHM(),
                "toToken must be sOHM or wsOHM"
            );
            uint256 toInvest = _pullTokens(fromToken, amountIn, affiliate, true);
            uint256 tokensBought = _fillQuote(
                fromToken,
                olympusZapManager.OHM(),
                toInvest,
                swapTarget,
                swapData
            );
    ...
    function ZapOut(
        ...
        require(
            fromToken == olympusZapManager.sOHM() || fromToken == olympusZapManager.wsOHM(),
    ...
    function update_olympusZapManager(IOlympusZapManager _olympusZapManager)
        external
        onlyOlympusZapManagerOwner
    {
