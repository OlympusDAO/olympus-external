...
contract OrderBook {
    ...
    function makerHashesLength(address maker) public view returns (uint256) {
    ...
    function allHashesLength() public view returns (uint256) {
    ...
    function getOrder(bytes32 hash) public view returns (Orders.Order memory) {
